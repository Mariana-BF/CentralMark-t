...
Route::get('/repartidores', 'HomeController@repartidores')->name('repartidores');
...
Route::get('/user/carne','PlatilloController@getcarne')->name('platillos.carne');
...
Route::post('/order/create', 'OrdenController@create')->name('Order.crear');
...
Route::get('/orden/finalizar','OrdenController@FinalizarOrden')->name('Orden.pedidofinalizado');
