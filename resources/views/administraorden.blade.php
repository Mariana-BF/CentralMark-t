...
<h2 class="text-center mb-5 mt-5">Administra tus pedidos</h2>
    ...
    <div class="col-md-10 mx-auto bg-white p-3">
        <h3 class="mb-3">Pedidos enviados</h3>
        <table class="table">
            <thead class="colorTabla text-light">
                <tr class="text-center">
