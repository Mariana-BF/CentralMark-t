          ...
          @method('PUT')
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="categoria" id="exampleFormControlSelect1">
               ...
               <option value="Frutas" {{ $platillo->categoria == 'Frutas' ? 'Selected' : '' }}>Frutas</option>
               <option value="Verduras" {{ $platillo->categoria =='Verduras' ? 'Selected' : '' }}>Verduras</option>
               <option value="Carnes" {{ $platillo->categoria =='Carnes' ? 'Selected' : '' }}>Carnes</option>
               <option value="Lacteos" {{ $platillo->categoria =='Lacteos' ? 'Selected' : '' }}>Lacteos</option>
        ...
        <form class="md-form">
            <div class="file-field">
              <div class="mb-4 text-center">
                <img id="previsualizar" src="/storage/{{$platillo->imagen}}" width="200" height="200"
                
                  class="rounded-circle z-depth-1-half avatar-pic" alt="example placeholder avatar" width="200px" height="200px">
              </div>
